...
public class PostController {
	...
	@PutMapping("/post/{id}")
	public @ResponseBody CMRespDto<?> update(@PathVariable Integer id,@RequestBody PostSaveReqDto postSaveReqDto) {
		Post postEntity = postService.수정하기(id,postSaveReqDto);
